...
<div class="container">
    <h2 style="text-align: center">@if(isset($title))
            {{ $title }}
        @else
            {{ company()->cname }}
        @endif</h2>
    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff" style="margin: 0 auto;"
           class="bg_color">
        <tr>
            <td align="center">
                <table border="0" align="center" width="100" cellpadding="0" cellspacing="0" class="">
                    <tr>
                        @yield('content')
                    </tr>
                </table>
