...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.miscs.edit') }}</small>
    </h1>
@endsection
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::model($miscs, ['route' => ['biller.miscs.update', $miscs], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-misc']) }}

                                    <div class="form-group">
                                        {{-- Including Form blade file --}}
                                        @include("focus.miscs.form")
