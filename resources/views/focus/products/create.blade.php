                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    {{ Form::open(['route' => 'biller.products.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post','files' => true, 'id' => 'create-product']) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(strlen($fields)>1)
                                            ...
                                            <hr>
                                            <a class="card-title purple"><i
                                                        class="fa fa-plus-circle"></i> {{trans('customfields.customfields')}}
                                            </a>
