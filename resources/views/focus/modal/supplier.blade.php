<div class="modal fade" id="addCustomer" role="dialog">
    <div class="modal-dialog modal-xl">
        ...
        {{ Form::open(['route' => 'biller.suppliers.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post','files' => true, 'id' => 'data_form_model_1']) }}

        <!-- Modal Header -->
            <div class="modal-header bg-gradient-directional-purple white">

                <h4 class="modal-title" id="myModalLabel">{{trans('purchaseorders.add_supplier')}}</h4>
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="action-url-model_1" value="{{route('biller.suppliers.store')}}">
