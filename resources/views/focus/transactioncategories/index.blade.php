...
@section ('title', trans('labels.backend.transactioncategories.management'))

@section('page-header')
    <h1>{{ trans('labels.backend.transactioncategories.management') }}</h1>
@endsection
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <table id="transactioncategories-table"
...
@section('after-scripts')
    ...
    <script>
        $(function () {
            ...
            var dataTable = $('#transactioncategories-table').dataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                language: {
                ...
                ajax: {
                    url: '{{ route("biller.transactioncategories.get") }}',
                    type: 'post'
                },
                columns: [
