{{ Form::open(['route' => array('biller.reports.generate_stock_statement','product_category_statement'), 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post','files' => false, 'id' => 'statement']) }}
<div class="form-group row">
    <label class="col-sm-3 col-form-label"
           for="pay_cat">{{trans('productcategories.productcategories')}}</label>

    <div class="col-sm-6">
        <select id="wfrom" name="product_category" class="form-control">
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        ...
        <input type="hidden" value="product_category_statement" name="stock_action">
