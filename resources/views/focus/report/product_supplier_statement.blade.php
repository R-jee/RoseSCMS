...
<div class="form-group row">
    <label class="col-sm-3 col-form-label"
           for="pay_cat">{{trans('suppliers.supplier')}}</label>
...
<div class="form-group row">
    ...
    <div class="col-sm-3">
        <select name="type_p" class="form-control">
            ...
            <option value='sales'>{{trans('meta.purchase')}}</option>
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        ...
        <input type="hidden" value="product_supplier_statement" name="stock_action">
