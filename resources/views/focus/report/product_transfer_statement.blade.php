{{ Form::open(['route' => array('biller.reports.generate_stock_statement','stock_transfer_product'), 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post','files' => false, 'id' => 'statement']) }}
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        ...
        <input type="hidden" value="product" name="stock_action">
