...
(function($) {
    ...
    function rsubmitForm() {
          $("#e_btn").hide();
        $("#r_wait").show();
       var act=$("#requestForm").attr('data-action');
                $.ajaxSetup({
                headers: {
    ...
    function csubmitForm() {
       ...
       $("#c_send").hide();
        $("#wait").show();
        var act=$("#contactForm").attr('data-action');
