                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                                        <span><?php echo e(trans('navs.frontend.login')); ?></span></h6>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form method="post" class="form-horizontal form-simple"
                                              action="<?php echo e(route('biller.login')); ?>" validate>
                                            <?php echo csrf_field(); ?>
...
<strong><?php echo e($errors->first('g-recaptcha-response')); ?></strong>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6 col-12 text-center text-sm-right"><a
                                                            href="<?php echo e(route('frontend.auth.password.reset')); ?>"
                                ...
                                <div class="card-footer">
                                    <div class="">
                                        <a href="<?php echo e(route('crm.login')); ?>"
                                           class="card-link"><?php echo e(trans('meta.customer_login')); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
